/*
	...
	Description:
	Initializes global Class variables.
...
comment "Officer";
Spec_var_oplClass = "O_officer_F";
comment "Squad Leader";
Spec_var_funkerClass = "O_Soldier_SL_F";
comment "Combat Life Saver";
Spec_var_medicClass = "O_medic_F";


comment "Team Leader";
Spec_var_tfClass = "O_Soldier_TL_F";
comment "Grenadier";
