...
if(_parameterCorrect) then {
    ...
    if(_type in [CLASS_OPL, CLASS_TF, CLASS_COMMANDER]) then {
    ...
    if(_type in [CLASS_OPL, CLASS_TF, CLASS_FUNKER, CLASS_LOGISTIC, CLASS_MEDEVAC, CLASS_PILOT, CLASS_COMMANDER, CLASS_JET]) then {
