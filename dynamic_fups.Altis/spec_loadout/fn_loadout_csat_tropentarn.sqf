...
private _uniform = "U_O_T_Soldier_F";
private _vest = "V_Chestrig_rgr";
...
private _standardWeapon = "arifle_CTAR_blk_F";
private _standardAmmo = "30Rnd_580x42_Mag_F";
private _standardAccessory = ["acc_pointer_IR","optic_Arco_ghex_F"];
...
private _grenadeLauncherWeapon = "arifle_CTAR_GL_blk_F";
