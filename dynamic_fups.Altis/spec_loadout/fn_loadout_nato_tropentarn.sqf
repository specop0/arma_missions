...
private _uniform = "U_B_T_Soldier_F";
private _vest = "V_PlateCarrier2_tna_F";

private _backpack = "B_AssaultPack_tna_F";
private _backpackBig = "B_Carryall_oli";
private _backpackLR = "TFAR_anprc155"; //tf_rt1523g_big

private _headgear = "H_HelmetB_Light_tna_F";
private _headgearPilot = "H_PilotHelmetHeli_B";
private _goggles = "G_Combat_Goggles_tna_F";

private _standardWeapon = "arifle_MX_khk_F";
private _standardAmmo = "30Rnd_65x39_caseless_mag";
private _standardAccessory = ["acc_pointer_IR", "optic_ERCO_khk_F"];
private _standardAccessoryExtra = ["optic_Holosight_khk_F"];

private _secondaryWeapon = "hgun_P07_khk_F";
private _secondaryAmmo = "16Rnd_9x21_Mag";
private _secondaryAccessory = [];

comment "Weapon with Underslung Grenade Launcher";
private _grenadeLauncherWeapon = "arifle_MX_GL_khk_F";
...
private _lmgWeapon = "arifle_MX_SW_khk_F";
