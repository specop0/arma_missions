...
private _mgWeapon = _standardWeapon;
...
private _lmgWeapon = _standardWeapon;
...
if(_parameterCorrect) then {
    ...
    if(_type == CLASS_MG) then {
        [_unit,_mgAmmo,ADD_ANYWHERE, 6] call Spec_fnc_addItemToContainer;
        ...
        if(_type == CLASS_LMG) then {
            [_unit,_lmgAmmo,ADD_ANYWHERE, 6] call Spec_fnc_addItemToContainer;
