...
if(_parameterCorrect) then {
    ...
    [_unit,"ACE_M84",ADD_ANYWHERE, 2] call Spec_fnc_addItemToContainer;
    ...
    switch _type do {
        case CLASS_TF : {
            [_unit,"rhs_VOG25",ADD_TO_BACKPACK, 6] call Spec_fnc_addItemToContainer;
            [_unit,"rhs_GRD40_Red",ADD_TO_BACKPACK, 6] call Spec_fnc_addItemToContainer;
        };
        case CLASS_GL : {
            [_unit,"rhs_VOG25",ADD_TO_BACKPACK, 12] call Spec_fnc_addItemToContainer;
        };
        case CLASS_FUNKER : {
            [_unit,"rhs_GRD40_Red",ADD_TO_BACKPACK, 6] call Spec_fnc_addItemToContainer;
        };
